...
def connect(*, home: Path, brand: str) -> None:
    ...
    1. Go to https://api.slack.com/apps → Create New App → From scratch
       Name: "Compai Swarm" · Workspace: your workspace
...
""")
    ...
    5. Optional: Add the bot to your #compai-ops channel (create it if missing)
""")
    ...
    channel = common.prompt("Primary ops channel (e.g. 'compai-ops') — leave blank to skip").strip().lstrip("#")
