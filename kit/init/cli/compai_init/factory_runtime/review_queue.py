...
Files are plain markdown so `compai-init ingest review` CLI (from Phase 1
...
def _render_review_md(event_id: str, result: "OrchestrationResult") -> str:
    from compai_init.factory_runtime.trace import to_markdown
    lines = [
